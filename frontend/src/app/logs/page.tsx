  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Monitor and debug cron job executions</p>
      </div>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <Select value={filterScript} onValueChange={setFilterScript}>
          ...
          <SelectContent>
            ...
            <SelectItem value="vapi-sync">VAPI Sync</SelectItem>
            <SelectItem value="qci-analysis">QCI Analysis</SelectItem>
            <SelectItem value="prompt-optimizer">Prompt Optimizer</SelectItem>
          </SelectContent>
        </Select>
      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
                  ...
                  {selectedRun.calls_analyzed !== null && (
                    <div>
                      <div className="text-xs text-gray-600">Analyzed</div>
                      <div className="font-semibold">{selectedRun.calls_analyzed}</div>
                    </div>
                  )}
                  {selectedRun.api_cost !== null && (
                    <div>
                      <div className="text-xs text-gray-600">API Cost</div>
                      <div className="font-semibold">${selectedRun.api_cost.toFixed(2)}</div>
                    </div>
                  )}
